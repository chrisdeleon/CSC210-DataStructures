...
public class LinkedList {
    ...
    public static class LLNode {
        ...
        // left and right pointers for binary tree
        LLNode left = null;
        LLNode right = null;
    ...
    // method for inserting a new LLNode into the linked list
        ...
        /****************************************/
        /* BLOCK OF CODE FOR BINARY TREE METHOD */
        /****************************************/
        
        
        // provided methods for inserting nodes
        void insertNode(int data){
            head = insertHelper(head, data);
        }
        
        // code provided 
        LLNode insertHelper(LLNode subRoot, int data){
            if (subRoot == null){
                subRoot = new LLNode(data);
                return subRoot;
            }
            if (data < subRoot.data){
                subRoot.left = insertHelper(subRoot.left, data);
            } else if (data > subRoot.data){
                subRoot.right = insertHelper(subRoot.right, data);
            }
        ...
        /************************************/
        /* END BLOCK FOR BINARY TREE METHOD */
        /************************************/
    ...
    public static void main(String[] args) {
        ...
        /* In class project, create a binary tree using the code created from the homework project */
